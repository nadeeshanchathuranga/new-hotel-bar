<template>
          ...
          >
            ...
            >
              ...
              <p class="text-[15px] text-center text-gray-700">
                Are you sure you want to delete this Service Charge? This action cannot
                be undone.
              </p>
  ...
  const deleteItem = () => {
  if (!selectedServiceCharge?.id) return;

  form.delete(`/service-charge/${selectedServiceCharge.id}`, {
    onSuccess: () => {
